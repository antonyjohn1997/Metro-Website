...
public partial class Payment_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            lblMurchant.Text = Session["username"].ToString();
   ...
   p.insupdel("update_charge", Session["cardno"].ToString());
   //CRUD.insUpDel("delst", Session["cardno"], Session["amount"]);
   //CRUD.insUpDel("delr", Session["cardno"], Session["amount"]);
   //CRUD.insUpDel("deln", Session["cardno"], Session["amount"]);
